...
| --- | --- | --- | --- | --- |
| [`go-webengine`](https://github.com/go-webengine) | 2 | [site](https://go-webengine.github.io/) | [docs](https://go-webengine.github.io/docs/) | A headless web engine: HTML and CSS laid out and painted to an image, with no Chromium — plus a service that streams those frames to a thin client. |
| [`go-browserhttp`](https://github.com/go-browserhttp) | 1 | [site](https://go-browserhttp.github.io/) | [docs](https://go-browserhttp.github.io/docs/) | An http.Client that presents a Chrome TLS fingerprint. |
