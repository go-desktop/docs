...
| [`nano-container-linux`](https://github.com/nano-container-linux) | 7 | [site](https://nano-container-linux.github.io/) | — | A minimal container host — OCI initrd and PXE boot, a DNS daemon, an OpenPubKey agent. |
