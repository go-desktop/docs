...
| --- | --- | --- | --- | --- |
| [`go-widgets`](https://github.com/go-widgets) | 19 | [site](https://go-widgets.github.io/) | — | The widget toolkit and every surface it paints on: the painter seam, MVVM, a declarative skin engine, a terminal back-end, a native window on X11, Wayland, Cocoa and Win32, application lifecycle with a system tray, a real Android APK, and a desktop shell. |
