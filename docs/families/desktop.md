...
| [`go-icons`](https://github.com/go-icons) | 6 | [site](https://go-icons.github.io/) | — | Icon and logo packs as embedded pure-Go SVG data — Simple Icons brand marks, Devicon, Material and Seti file types, vscode-icons, and Iconoir. One repository per pack, so a program embeds the set it draws and not the other five; the drawing itself is go-gfx's `svg` package. This pair replaced the archived go-iconoir. |
